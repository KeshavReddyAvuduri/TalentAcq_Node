...
router.get("/getAppDetailsByMobileNo", function (req, res, next) {
    console.log("/getAppDetailsByMobileNo GET API call in JobApplicationController");

    //service call goes here
    jobApplicationService.getAppDetailsByMobileNo(req, res);
});
